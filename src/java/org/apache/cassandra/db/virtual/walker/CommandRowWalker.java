...
/**
 * The {@link org.apache.cassandra.db.virtual.model.CommandRow} row metadata and data walker.
 *
 * @see org.apache.cassandra.db.virtual.model.CommandRow
 */
public class CommandRowWalker implements RowWalker<CommandRow>
{
    @Override
    ...
    @Override
    public void visitRow(CommandRow row, RowMetadataVisitor visitor)
    {
