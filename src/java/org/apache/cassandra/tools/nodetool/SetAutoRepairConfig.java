...
public class SetAutoRepairConfig extends AbstractCommand
{
    ...
    @Parameters(index = "0", description = { "Autorepair param type.",
    ...
    @Parameters(index = "1", description = "Autorepair param value")
    ...
    {
        args = CommandUtils.concatArgs(autorepairParamType, autorepairParamValue);
