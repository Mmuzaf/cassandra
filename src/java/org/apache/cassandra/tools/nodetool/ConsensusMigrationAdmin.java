...
public class ConsensusMigrationAdmin extends AbstractCommand
{
    ...
    public static class ListCmd extends AbstractCommand
    {
        ...
        @Parameters(index = "1..*", arity = "0..*", description = "The tables to list")
        ...
        protected void execute(NodeProbe probe)
        {
            schemaArgs = CommandUtils.concatArgs(keyspace, tables);
    ...
    public static class BeginMigration extends AbstractCommand
    {
        ...
        @Parameters(index = "0", description = "The keyspace followed by one or many tables")
        public String keyspace;

        @Parameters(index = "1..*", description = "The tables to list")
        public String[] tables;
