...
public class KeyspaceMetrics
{
    ...
    public void release()
    {
        Metrics.removeIfMatch(fullName -> resolveShortMetricName(fullName, KeyspaceMetricNameFactory.GROUP_NAME, TYPE_NAME),
    ...
    static class KeyspaceMetricNameFactory implements MetricNameFactory
    {
        ...
        public MetricName createMetricName(String metricName)
        {
            ...
            return new MetricName(GROUP_NAME, TYPE_NAME, metricName, keyspaceName, mbeanName.toString());
        }
    }
}
