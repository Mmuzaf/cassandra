...
public class SimulationRunner
{
    ...
    protected abstract static class BasicCommand<B extends ClusterSimulation.Builder<?>> implements Runnable
    {
        ...
        @Option(names = { "--transactional-mode" }, description = { "What execution strategy to use for CAS and serial read", "[off|mixed_reads|full]" })
    ...
    protected static class VersionCommand<B extends ClusterSimulation.Builder<?>> implements Runnable
    {
        @Override
        public void run()
        {
