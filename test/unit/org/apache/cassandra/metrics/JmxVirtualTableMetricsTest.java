...
public class JmxVirtualTableMetricsTest extends CQLTester
{
    ...
    public void testAliasesWithJmxVirtualTables() throws Exception
    {
        ...
        MetricNameFactory factory = registry.regsiterMetricFactory(new DefaultNameFactory("Table", "AliasTestScopeFirst"));
        MetricNameFactory aliasFactory = registry.regsiterMetricFactory(new DefaultNameFactory("Index", "AliasTestScopeSecond"));
