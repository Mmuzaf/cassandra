...
-------------------+---------------------
    ...
    CIDRAuthorizer |     cidr_authorizer
               CQL |                 cql
             Cache |               cache
        ChunkCache |         chunk_cache
            Client |              client
 ClientMessageSize | client_message_size
 ...
 ClientRequestSize | client_request_size
    ...
    DroppedMessage |     dropped_message
      HintsService |       hints_service
             Index |               index
 IndexColumnFamily | index_column_family
        IndexTable |         index_table
  InternodeInbound |   internode_inbound
          Keyspace |            keyspace
